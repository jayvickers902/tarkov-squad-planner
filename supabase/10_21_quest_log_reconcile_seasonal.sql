-- Phase 10 migration 21: allow the seasonal PvP quest list to use the same
-- authenticated, monotonic log reconciliation path as Regular and PvE.
-- Seasonal remains a distinct game_mode and can never overwrite another mode.
